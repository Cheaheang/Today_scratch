...
var Scratch = /*#__PURE__*/function (_Component) {
  ...
  function Scratch(props) {
    ...
    _this.handleMouseDown = function (e) {
      ...
      _this.lastPoint = _this.getMouse(e, _this.canvas);
    };
    ...
    _this.handleMouseMove = function (e) {
      ...
      var currentPoint = _this.getMouse(e, _this.canvas);

      var distance = _this.distanceBetween(_this.lastPoint, currentPoint);

      var angle = _this.angleBetween(_this.lastPoint, currentPoint);

      var x, y;

      for (var i = 0; i < distance; i++) {
        x = _this.lastPoint ? _this.lastPoint.x + Math.sin(angle) * i : 0;
        y = _this.lastPoint ? _this.lastPoint.y + Math.cos(angle) * i : 0;
  ...
  _proto.distanceBetween = function distanceBetween(point1, point2) {
    if (point1 && point2) {
  ...
  _proto.angleBetween = function angleBetween(point1, point2) {
    if (point1 && point2) {
  ...
  _proto.handlePercentage = function handlePercentage(filledInPixels) {
    if (filledInPixels === void 0) {
      filledInPixels = 0;
    }
...
exports.CUSTOM_BRUSH_PRESET = CUSTOM_BRUSH_PRESET;
